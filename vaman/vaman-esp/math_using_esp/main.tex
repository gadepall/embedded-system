...
\begin{table}[ht!]
\input{./vaman/vaman-esp/math_using_esp/tables/table.tex}
\caption{}
\label{Table-1}	
...
\end{table}
	...
	\begin{figure}[!h]
		\begin{center}
			\includegraphics[width=\columnwidth]{./vaman/vaman-esp/math_using_esp/figs/line_3d.png}
		\end{center}
		\caption{}
		\label{fig:Fig1}
	\end{figure}
...
\begin{lstlisting}
vaman/vaman-esp/math_using_esp/codes/esp_code/src/main.cpp
\end{lstlisting}
\item Build the ESP32 firmware
\begin{lstlisting}
cd  vaman/vaman-esp/math_using_esp/codes/esp_code
pio run
\end{lstlisting} 
...
\begin{figure}[H]
\centering
\includegraphics[scale =0.3]{./vaman/vaman-esp/math_using_esp/figs/1.jpg}
\caption{Website}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./vaman/vaman-esp/math_using_esp/figs/2.jpg}
